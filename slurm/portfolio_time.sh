...
#SBATCH -o /scratch/gpfs/iywang/mro_results/portfolio/K5_r10_2/portfolio_test_%A_.txt
...
python portfolio_time/portMIP.py --foldername /scratch/gpfs/iywang/mro_results/portfolio/K5_r10_2/ --K 5
