...
#SBATCH --time=1:00:00
#SBATCH -o /scratch/gpfs/iywang/mro_results/quadratic_concave/m10_K90_r20/quadratic_test_%A.txt
...
#python quadratic_concave/plots.py --foldername /scratch/gpfs/iywang/mro_results/quadratic_concave/m10_K90_r20/
