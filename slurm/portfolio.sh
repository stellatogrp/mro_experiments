...
#SBATCH -o /scratch/gpfs/iywang/mro_results/portfolio/new/m30_K1000_r10/portfolio_test_%A_.txt
...
python portfolio/MIP/portMIP.py --foldername /scratch/gpfs/iywang/mro_results/portfolio/new/m30_K1000_r10/
